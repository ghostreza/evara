...
STORY = [
    "Evara tidak lahir di galangan kapal — ia lahir dari sebuah janji. Donald dan Joanita, sepasang suami istri yang diikat bukan hanya oleh janji pernikahan, tetapi juga oleh cinta yang dalam pada laut: menyelam di terumbu, melempar pancing saat fajar, dan membaca bintang dalam navigasi. Bagi mereka, laut bukan tujuan — laut adalah rumah.",
    "Sebagai bentuk cinta dan apresiasi tertinggi, Donald mempersembahkan sebuah perahu nelayan rekreasi untuk Joanita. Bukan sekadar hadiah, melainkan perwujudan dari perempuan yang menjadi teman seperjalanan hidupnya. Perahu itu ia namai Evara.",
    "Evara berarti “hadiah terindah dari Tuhan” — sebagaimana Joanita di mata Donald. Sejak hari itu, setiap fajar yang dibelah di atas ombak, setiap tali pancing yang diulur, dan setiap penyelaman ke birunya laut adalah rasa syukur yang tak pernah selesai diucapkan.",
...
SEO_FAQ = [
    {"question": "Bagaimana cara ke Pulau Tidung dari Jakarta?", "answer": "Dari Jakarta, Anda dapat berangkat melalui Pelabuhan Kali Adem atau Muara Angke dengan kapal kayu atau kapal express. Alternatif lainnya adalah Pelabuhan Sunda Kelapa. Jadwal dan tarif dapat berubah mengikuti operator, cuaca, dan ketersediaan kursi."},
    {"question": "Bagaimana cara ke Pulau Tidung dari Tangerang?", "answer": "Dari Tangerang, rute yang praktis adalah Pelabuhan Cituis di Kabupaten Tangerang. Kapal lokal biasanya berangkat pagi dengan estimasi perjalanan sekitar 1,5–2 jam; konfirmasi jadwal pada hari keberangkatan sebelum datang."},
    {"question": "Berapa harga snorkeling Pulau Tidung?", "answer": "Harga snorkeling Evara mulai dari Rp250.000 per orang untuk durasi maksimal 1,5 jam di satu spot, minimal 3 dan maksimal 6 orang. Tambahan tour guide serta photo dan video tersedia seharga Rp200.000 per trip."},
    {"question": "Apa saja spot snorkeling Pulau Tidung?", "answer": "Spot yang dapat dipilih antara lain Perairan Pulau Tidung Kecil, Area Jembatan Cinta, Pulau Payung, Gusong Karang Beras, dan Pulau Tikus. Pemilihan spot menyesuaikan cuaca, arus, dan kondisi laut."},
    {"question": "Bagaimana jadwal kapal ke Pulau Tidung dari Muara Angke?", "answer": "Kapal kayu dari Kali Adem/Muara Angke umumnya menuju Tidung sekitar pukul 07.00–07.30 WIB, sedangkan kapal express sekitar pukul 07.30–08.00 WIB. Tiba minimal satu jam lebih awal dan cek ulang jadwal operator karena dapat berubah."},
    {"question": "Berapa biaya sewa perahu Pulau Tidung untuk mancing?", "answer": "Fishing trip Evara berlangsung full day hingga 8 jam. Harga per orang mulai Rp250.000 untuk 5–6 orang, Rp300.000 untuk 3–4 orang, dan Rp500.000 untuk 1–2 orang. Harga final dikonfirmasi berdasarkan tanggal, rute, cuaca, dan BBM."},
    {"question": "Apakah tersedia diving Pulau Tidung untuk pemula?", "answer": "Spot seperti Tepi Karang Tidung Kecil memiliki drop-off 10–18 meter dan cocok untuk fun dive serta pemula Open Water. Layanan diving resmi Evara direncanakan mulai 2027; jadwal, instruktur, dan harga akan diumumkan saat operasional dibuka."},
    {"question": "Berapa biaya ke Pulau Tidung untuk 2 hari 1 malam?", "answer": "Biaya 2 hari 1 malam terdiri dari tiket kapal pulang-pergi, penginapan, makan, aktivitas, dan transportasi lokal. Karena harga penginapan dan tiket dapat berubah, hubungi Evara untuk menyusun estimasi sesuai jumlah orang dan pilihan aktivitas."},
]
